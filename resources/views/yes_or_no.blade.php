...
<head>
    ...
    <title>Benar / Salah {{ $category->name }} — Investdu</title>
    <meta name="description" content="Uji insting investasi Anda tentang {{ $category->name }} dengan permainan Benar atau Salah di Investdu.">
...
<body>
    ...
    <div class="quiz-wrapper">
        ...
        <div class="quiz-header">
            <div class="quiz-header-left">
                ...
                <div>
                    <div class="quiz-title">Benar / Salah {{ $category->name }}</div>
        ...
        <div class="loading-screen" id="loadingScreen">
            ...
            <p class="loading-text">Memuat arena permainan Benar / Salah {{ $category->name }}...</p>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', async () => {
            try {
                // Fetch ONLY yes/no questions
                const yesnoRes = await fetch(`/api/yes-or-no/questions?category_id=${CATEGORY_ID}`).then(r => r.json());
